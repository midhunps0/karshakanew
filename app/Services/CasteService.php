...
class CasteService implements ModelViewConnector {
    ...
    public function getCreatePageData(): array
    {
        return [
            'title' => 'Create Caste',
            'form' => [
                'id' => 'form_castes_create',
                'action_route' => 'castes.store',
                'success_redirect_route' => 'castes.index',
