<x-easyadmin::partials.adminpanel>
    <div>
        <h3 class="text-xl font-bold pb-3"><span>Active/Inactive Status Report</span>&nbsp;</h3>
        <form x-data="{
                districts: [],
                district: '',
                taluks: [],
                ...
                doSubmit() {
                    ...
                    $dispatch('linkaction', {link: '{{route('members.report.status')}}', route: 'members.report.status', params: params, fresh: true});
                    {{-- axios.get(
                        url,
                        {
            ...
            <div class="flex flex-row space-x-4 items-end justify-center my-4">
                <div class="w-1/3">
                    <label>Status</label>
                    <select x-model="active" name="active" class="select select-sm py-0 select-bordered w-full">
