<x-easyadmin::partials.adminpanel>
    <div>
        <h3 class="text-xl font-bold pb-3 print:hidden"><span>Edit Higher Education Allowance Application</span>&nbsp;</h3>
        ...
        <div>
            <form x-data="{
                    ...
                    doSubmit() {
                        ...
                        axios.post(
                            '{{route('allowances.higher_education.update', $allowance->id)}}',
                            formData,
                            {
                                headers: {
                ...
                x-init="
                    ...
                    student_name = '{{\App\Helpers\AppHelper::jssafe($allowance->allowanceable->student_name)}}';
...
{{--
                    ...
                    passed_exam_details = {
                        ...
                        reg_no: `{{$allowance->allowanceable->passed_exam_details['exam_reg_no']}}`,
                        institution: `{{$allowance->allowanceable->passed_exam_details['institution']}}`,
                       affiliated_board: `{{$allowance->allowanceable->passed_exam_details['affilated_board']}}`,
                ...
                <fieldset class="flex flex-row p-2 my-2 py-4 space-x-2 border border-base-content border-opacity-10 rounded-md w-full">
                    ...
                    <div class="form-control flex-grow">
                        ...
                        <textarea name="passed_exam_details[institution]" x-model="passed_exam_details.institution" class="textarea textarea-sm textarea-bordered h-16 max-w-xs"></textarea>
                    </div>
                    <div class="form-control w-1/5">
                        <label class="label opacity-70">
