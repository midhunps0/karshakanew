        ...
        <div>
            <form x-data="{
                        ...
                        <tbody>
                            <template x-for="(b, i) in medical_bills">
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" x-show="medical_bills.length > 1" class="btn btn-xs btn-error"  @click.prevent.stop="removeBill(i);">
                                            <x-easyadmin::display.icon   icon="easyadmin::icons.minus"
                                            height="h-4" width="w-4"/>
                                        </button>
                                        <button type="button" x-show="i == medical_bills.length - 1" class="btn btn-xs btn-warning" @click.prevent.stop="addBill();">
                ...
                <div class="flex flex-row flex-wrap">
                    ...
                    @endif
                    @if ($member->getSingleMediaUlid('doctors_certificate') == null)
                    <div class="w-1/3 p-4">
                        <x-easyadmin::inputs.imageuploader :element="[
                    ...
                    <div class="w-1/3 p-4">
                        ...
                        value="{{$member->getSingleMediaUlid('doctors_certificate')}}">
                        <label class="label opacity-70">Doctor\'s certificate</label>
                        <img class="w-28" src="{{$member->birth_certificate['path']}}" alt="">
                    </div>
                    @endif
                    @if ($member->getSingleMediaUlid('op_card_discharge_summary') == null)
                    <div class="w-1/3 p-4">
                        <x-easyadmin::inputs.imageuploader :element="[
                    ...
                    <div class="w-1/3 p-4">
                        ...
                        value="{{$member->getSingleMediaUlid('op_card_discharge_summary')}}">
                        <label class="label opacity-70">OP Card or Discharge Summary</label>
                        <img class="w-28" src="{{$member->birth_certificate['path']}}" alt="">
                    </div>
                    @endif
                    @if ($member->getSingleMediaUlid('medical_bills_proofs') == null)
                    <div class="w-1/3 p-4">
                        <x-easyadmin::inputs.imageuploader :element="[
                    ...
                    <div class="w-1/3 p-4">
                        ...
                        @foreach ($member->getAllMediaForDisplay('medical_bills_proofs') as $m)
