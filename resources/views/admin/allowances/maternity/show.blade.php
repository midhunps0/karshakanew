<x-easyadmin::partials.adminpanel>
    <div>
        <h3 class="text-xl font-bold pb-3 print:hidden"><span>Maternity Allowance Application</span>&nbsp;</h3>
        <div class="text-right p-4 flex flex-row justify-between">
            @if(isset($application) && $application->editable_by_status)
            <a href="" class="btn btn-sm btn-warning" @click.prevent.stop="$dispatch('linkaction', {link: '{{route('allowances.maternity.edit', $application->id)}}'});" >Edit</a>
            @else
        ...
        @if (isset($application->allowanceable))
            ...
            <div class="flex flex-row flex-wrap">
                <div class="my-2 p-y2 w-1/3"><span class="font-bold opacity-60">Member's Name:<br/></span>&nbsp;<span>{{$application->allowanceable->member_name}}</span></div>
                <div class="my-2 p-y2 w-1/3"><span class="font-bold opacity-60">Member's Address:<br/></span>&nbsp;<span>{{$application->allowanceable->member_address}}</span></div>
                <div class="my-2 p-y2 w-1/3"><span class="font-bold opacity-60">Member's Aadhaar No.:<br/></span>&nbsp;<span>{{$application->allowanceable->member_aadhaar}}</span></div>
                <div class="my-2 p-y2 w-1/3"><span class="font-bold opacity-60">Member's Phone No.:<br/></span>&nbsp;<span>{{$application->allowanceable->member_phone}}</span></div>
            ...
            <div class="flex flex-row flex-wrap mt-3">
                <div class="my-2 p-y2 w-1/2"><span class="font-bold opacity-60">Delivery Date</span>&nbsp;<span>{{$application->allowanceable->delivery_date}}</span></div>
                <div class="my-2 p-y2 w-1/2"><span class="font-bold opacity-60">Total number of deliveries including current</span>&nbsp;<span>{{$application->allowanceable->delivery_count}}</span></div>
                <div class="my-2 p-y2 w-1/2"><span class="font-bold opacity-60">Arrears on delivery date (No. of months):</span>&nbsp;<span>{{$application->allowanceable->arrear_months_dlrydt}}</span></div>
